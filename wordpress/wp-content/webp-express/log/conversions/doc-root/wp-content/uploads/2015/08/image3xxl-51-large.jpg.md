WebP Express 0.17.2. Conversion triggered using bulk conversion, 2019-10-12 08:05:17
...
Output:    83304 bytes Y-U-V-All-PSNR 39.77 49.34 48.54   41.27 dB
           (0.81 bpp)
block count:  intra4:       2213  (67.80%)
              intra16:      1051  (32.20%)
              skipped:       343  (10.51%)
bytes used:  header:            210  (0.3%)
             mode-partition:  10118  (12.1%)
 Residuals bytes  |segment 1|segment 2|segment 3|segment 4|  total
  intra4-coeffs:  |   56702 |    1912 |    1833 |     301 |   60748  (72.9%)
 intra16-coeffs:  |    4817 |    1290 |    1161 |     398 |    7666  (9.2%)
  chroma coeffs:  |    3455 |     326 |     508 |     245 |    4534  (5.4%)
    macroblocks:  |      61%|       9%|      11%|      19%|    3264
      quantizer:  |      24 |      19 |      13 |      11 |
   filter level:  |      26 |      21 |      26 |       5 |
------------------+---------+---------+---------+---------+-----------------
 segments total:  |   64974 |    3528 |    3502 |     944 |   72948  (87.6%)

Success
Reduction: 54% (went from 178 kb to 81 kb)
...
Output:    414850 bytes (4.04 bpp)
Lossless-ARGB compressed size: 414850 bytes
  * Header size: 5512 bytes, image data size: 409312
  * Lossless features used: PREDICTION CROSS-COLOR-TRANSFORM SUBTRACT-GREEN
  * Precision Bits: histogram=5 transform=4 cache=10

Success
Reduction: -128% (went from 178 kb to 405 kb)

Picking lossy
cwebp succeeded :)

Converted image in 1673 ms, reducing file size with 54% (went from 178 kb to 81 kb)
