WebP Express 0.17.2. Conversion triggered using bulk conversion, 2019-10-12 08:19:29
...
Output:    37196 bytes Y-U-V-All-PSNR 43.40 50.13 49.91   44.71 dB
           (0.36 bpp)
block count:  intra4:        994  (30.45%)
              intra16:      2270  (69.55%)
              skipped:      1797  (55.06%)
bytes used:  header:            170  (0.5%)
             mode-partition:   5477  (14.7%)
 Residuals bytes  |segment 1|segment 2|segment 3|segment 4|  total
  intra4-coeffs:  |   26893 |     103 |      41 |     117 |   27154  (73.0%)
 intra16-coeffs:  |     259 |      54 |      95 |     674 |    1082  (2.9%)
  chroma coeffs:  |    2964 |      37 |      39 |     244 |    3284  (8.8%)
    macroblocks:  |      25%|       1%|       1%|      73%|    3264
      quantizer:  |      27 |      26 |      20 |      15 |
   filter level:  |      12 |      46 |       9 |      18 |
------------------+---------+---------+---------+---------+-----------------
 segments total:  |   30116 |     194 |     175 |    1035 |   31520  (84.7%)

Success
Reduction: 59% (went from 89 kb to 36 kb)
...
Output:    202466 bytes (1.97 bpp)
Lossless-ARGB compressed size: 202466 bytes
  * Header size: 3174 bytes, image data size: 199266
  * Lossless features used: PREDICTION CROSS-COLOR-TRANSFORM SUBTRACT-GREEN
  * Precision Bits: histogram=5 transform=4 cache=10

Success
Reduction: -123% (went from 89 kb to 198 kb)

Picking lossy
cwebp succeeded :)

Converted image in 1482 ms, reducing file size with 59% (went from 89 kb to 36 kb)
