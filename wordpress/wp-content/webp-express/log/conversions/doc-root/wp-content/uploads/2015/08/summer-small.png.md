WebP Express 0.15.3. Conversion triggered using bulk conversion, 2019-09-24 05:38:16
...
Reduction: 52% (went from 2498 bytes to 1192 bytes)
...
Reduction: 56% (went from 2498 bytes to 1102 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 101 ms, reducing file size with 56% (went from 2498 bytes to 1102 bytes)
