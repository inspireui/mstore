...
Reduction: 41% (went from 5373 bytes to 3164 bytes)
...
Reduction: 9% (went from 5373 bytes to 4886 bytes)

Picking lossy
cwebp succeeded :)

Converted image in 159 ms, reducing file size with 41% (went from 5373 bytes to 3164 bytes)
