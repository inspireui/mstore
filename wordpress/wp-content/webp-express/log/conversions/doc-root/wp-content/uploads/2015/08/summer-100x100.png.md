WebP Express 0.17.2. Conversion triggered using bulk conversion, 2019-10-12 08:44:09
...
Lossless-alpha compressed size: 1229 bytes
  * Header size: 72 bytes, image data size: 1157
  * Precision Bits: histogram=3 transform=3 cache=0
  * Palette size:   96

Success
Reduction: 55% (went from 3219 bytes to 1446 bytes)
...
Reduction: 54% (went from 3219 bytes to 1474 bytes)

Picking lossy
cwebp succeeded :)

Converted image in 167 ms, reducing file size with 55% (went from 3219 bytes to 1446 bytes)
