...
Reduction: 48% (went from 1256 bytes to 656 bytes)
...
Reduction: 59% (went from 1256 bytes to 518 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 144 ms, reducing file size with 59% (went from 1256 bytes to 518 bytes)
