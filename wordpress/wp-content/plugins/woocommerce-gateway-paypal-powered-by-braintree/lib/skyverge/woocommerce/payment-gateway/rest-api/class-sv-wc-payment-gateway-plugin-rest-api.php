...
namespace WC_Braintree\Plugin_Framework\Payment_Gateway;
use WC_Braintree\Plugin_Framework\REST_API as Plugin_REST_API;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\WC_Braintree\\Plugin_Framework\\Payment_Gateway\\REST_API' ) ) :

/**
 * The payment gateway plugin REST API handler class.
 *
 * @see \WC_Braintree\Plugin_Framework\REST_API
 *
 * @since 5.2.0
 */
class REST_API extends Plugin_REST_API {
	 ...
	 *
	 * @see \WC_Braintree\Plugin_Framework\REST_API::get_system_status_data()
	 *
	 * @since 5.2.0
	 *
	 * @return array
